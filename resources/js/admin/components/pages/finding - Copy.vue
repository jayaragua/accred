                         ...
                         <!--    <b-table 
                            ...
                            <b-table 
                                    ...
                                    <b-table-column  label="Action" centered  v-slot="props" width="200">
                                        <span>
                                             <b-button type="is-info" size="is-small"  @click="showEditModal(props.index)" >Edit</b-button>
                                             <b-button type="is-danger" size="is-small" @click="showDeletingModal(props.index)" :loading="props.index.isDeleting" >Delete</b-button>
                                        </span>
                                    </b-table-column>
    ...
    export default {
        ...
        */
    		...
    		async editFinding(){
    			...
    			if(res.status===200){
                    this.findings[this.index].tab_num = this.editData.tab_num   
    				this.findings[this.index].title = this.editData.title
    				this.findings[this.index].deliverable = this.editData.deliverable
    				this.findings[this.index].progName = this.editData.progName
    				this.findings[this.index].area_id = this.editData.area_id
    				this.$Loading.finish();
    		...
    		showEditModal(index){
    			...
    			let obj = {
                    ...
                    tab_num : this.findings[index].tab_num,
    		...
    		async deleteFinding(){
    			...
    			if(res.status===200){
    				this.findings.splice(this.deletingIndex, 1)
    				this.$Loading.finish();
    		 ...
    		 showDeletingModal(index){
    			this.deleteItem = this.findings[index]
