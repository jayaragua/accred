                            ...
                            <h2>GADTC Accreditation</h2>
                             ...
                             <div class="_1adminOverveiw_card _box_shadow _border_radious _mar_b30 _1adminOverveiw_bg_one">
                                        <div class="container-fluid mt-2">
                                                <p class="_1adminOverveiw_card_left_title">2018 Candidate Status Deliverables</p>
                                            ...
                                            <div class="container-fluid">
                                                    <b-table 
                                                            ...
                                                            <b-table-column field="id" centered label="ID" width="80" sortable numeric v-slot="props">
                                                                {{ props.row.id }}
                                                            </b-table-column>
    ...
    export default{
       ...
       methods:{
            ...
            async fetchArea(){
                ...
                const res = await this.callApi('get', 'app/upload_view/'+ this.n_area)
                if(res.status==200){
            ...
            async fetchProgram(){
                const res = await this.callApi('get', 'app/upload_view_prog/'+ this.n_prog + '/' + this.n_area)
                if(res.status==200){
                     this.$Loading.finish();
                    this.finding_list = res.data
                    // console.log(this.finding_list)
